...
internal readonly record struct Rectangle
{
    ...
    public Line TopLine(Drawing.Pen? pen = null) =>
        new(this.TopLeft, this.TopRight, pen: pen);

    public Line RightLine(Drawing.Pen? pen = null) =>
        new(this.TopRight, this.BottomRight, pen: pen);

    public Line BottomLine(Drawing.Pen? pen = null) =>
        new(this.BottomRight, this.BottomLeft, pen: pen);

    public Line LeftLine(Drawing.Pen? pen = null) =>
        new(this.BottomLeft, this.TopLeft, pen: pen);

    public Line TopLeftBottomRightDiagonal(Drawing.Pen? pen = null) =>
        new(this.TopLeft, this.BottomRight, pen: pen);

    public Line BottomLeftTopRightDiagonal(Drawing.Pen? pen = null) =>
        new(this.BottomLeft, this.TopRight, pen: pen);
